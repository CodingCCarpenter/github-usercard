...
const gitHubCards = (username) => {
  ...
  */
    console.log(res);
    cards.appendChild(cardCreator(myGithubData));
...
gitHubCards('CodingCCarpenter');
  ...
  */
  ...
  profileP.classList.add('profile-p');
  profileLink.classList.add('profile-link');
  followers.classList.add('followers');
  following.classList.add('following');
  bio.classList.add('class-list');

  //add img src/alt
  img.src = res['avatar_url'];
  img.alt = `image of ${res.login}`;

  //add a href
  profileLink.href = res['html_url'];
